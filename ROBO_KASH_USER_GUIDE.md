...
The daily 7am property report always speaks, whether or not you switched voice on for chat
— `/voice off` stops that too. It arrives as the usual written messages, then a short
spoken briefing at the end: how much changed overnight, the biggest
